    ...
    <div>
      <div className="max-w-full mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4">
          ...
          <nav
            className="mt-3 sm:mt-0 inline-flex rounded-lg bg-[#F3F4F6] text-[13px] font-semibold text-[#0B1A72]"
            aria-label="Primary"
          >
            <Link
              to=""
              aria-current="page"
              className="px-4 py-2 rounded-lg bg-white border border-[#E5E7EB] text-[13px] font-semibold text-[#1F2937] cursor-default"
            >
              Customers
            </Link>
            <Link
              to=""
              className="px-4 py-2 hover:underline focus:underline focus:outline-none"
            >
              Customer bikes
            </Link>
            <Link
        ...
        <section className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4 space-y-3 sm:space-y-0">
          ...
          <div className="flex space-x-3 justify-end w-full sm:w-auto">
            <button
              type="button"
              className="border border-[#D1D5DB] rounded-md px-4 py-2 text-[14px] font-semibold text-[#2B2B9B] hover:bg-[#E5E7EB] focus:outline-none focus:ring-2 focus:ring-[#2B2B9B] flex items-center"
              aria-haspopup="true"
              aria-expanded="false"
            >
              Bulk Edit <i className="fas fa-caret-down ml-1 text-[10px]"></i>
            </button>
            <button
              type="button"
        ...
        <section className="border border-[#E5E7EB] rounded-lg p-4">
          <div className="flex space-x-4 mb-3">
            ...
            <button
              type="button"
              className="flex items-center space-x-2 rounded-md border border-transparent bg-white px-3 py-1 text-[14px] font-semibold text-[#2B2B9B] hover:bg-[#E5E7EB] focus:outline-none focus:ring-2 focus:ring-[#2B2B9B]"
              aria-pressed="false"
            >
